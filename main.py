...
PREMIUM_24H_PRICE_STARS = int(os.getenv("PREMIUM_24H_PRICE_STARS", "50"))
PREMIUM_7D_PRICE_STARS = int(os.getenv("PREMIUM_7D_PRICE_STARS", "150"))
PREMIUM_30D_PRICE_STARS = int(os.getenv("PREMIUM_30D_PRICE_STARS", "300"))
