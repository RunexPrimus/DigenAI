...
def _ensure_lang_keys():
    ...
    en.update({
        ...
        "inline_result_desc": "Tap to start (limits apply)",
        "inline_processing": "🔄 Processing your request… ({n})",
        "premium_video_button": "🎬 Explore Premium features",
    })
    ...
    uz.update({
        ...
        "inline_result_desc": "Bosib boshlang (limitlar amal qiladi)",
        "inline_processing": "🔄 So‘rov bajarilmoqda… ({n})",
        "premium_video_button": "🎬 Premium imkoniyatlarini ko'rish",

    })

    # premium_video_button — barcha tillar uchun tarjimalar
    _PREMIUM_VIDEO_TRANSLATIONS = {
        "ru":   "🎬 Посмотреть возможности Premium",
        "id":   "🎬 Lihat fitur Premium",
        "lt":   "🎬 Peržiūrėti Premium galimybes",
        "esmx": "🎬 Ver funciones Premium",
        "eses": "🎬 Ver funciones Premium",
        "it":   "🎬 Scopri le funzionalità Premium",
        "zhcn": "🎬 查看 Premium 功能",
        "bn":   "🎬 Premium সুবিধা দেখুন",
        "hi":   "🎬 Premium सुविधाएं देखें",
        "ptbr": "🎬 Ver recursos Premium",
        "ar":   "🎬 استعرض مزايا Premium",
        "uk":   "🎬 Переваги Premium",
        "vi":   "🎬 Xem tính năng Premium",
    }
    for lc, btn_text in _PREMIUM_VIDEO_TRANSLATIONS.items():
        ld = LANGUAGES.get(lc)
        if ld is not None:
            ld.setdefault("premium_video_button", btn_text)
    # Fallback for any other lang
    for lc, ld in LANGUAGES.items():
        ld.setdefault("premium_video_button", "🎬 Explore Premium features")


    # ─────────────────────────────────────────────────────────────────────────
    # Barcha tillar uchun to'liq tarjimalar (missing keys fixed)
    # ─────────────────────────────────────────────────────────────────────────
    _ALL_LANG_PATCHES = {
        "ru": {
            "gen_button_short": "Создать изображение",
            ...
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — быстрее, мощнее, без ограничений 🔥\n\n✅ 🔞 Adult/NSFW разблокирован 🍓\n✅ ⚡ Приоритет в очереди\n✅ 🖼 4 изображения за раз\n✅ 🚫 Без задержек\n\n🆓 Free: 1 изображение, задержка, дневной лимит, NSFW заблокирован.",
            "premium_plan_24h": "24 часа",
            "premium_plan_7d": "7 дней",
            "premium_plan_30d": "30 дней",
            "premium_buy": "Купить Premium",
            "premium_active_until": "✅ Premium активен до: {until}",
            "premium_not_active": "❌ Premium не активен.",
            "premium_activated": "✅ Premium активирован! NSFW разблокирован. Приоритет и 4 изображения за раз — наслаждайтесь!",
            "nsfw_blocked_free": "🔞 Контент для взрослых доступен только в Premium.\nУлучшите план — откройте NSFW 🍓 + 4 фото/запрос + приоритет ⚡",
            "batch_premium_only": "⭐ 2–4 изображения за запрос — только для Premium.",
            "quota_reached_friendly": "⏳ Вы исчерпали бесплатный лимит на сегодня.\nХотите больше? ⭐ Premium — безлимитно + приоритет ⚡",
            "cooldown_friendly": "⏳ Подождите {sec}с перед следующим бесплатным запросом.\n⭐ В Premium задержек нет.",
            "already_processing": "⚙️ У вас уже есть активный запрос. Подождите завершения.",
            "queued": "🕒 В очереди! Примерное ожидание ~{sec}с.",
            "processing": "🔄 Обрабатываю ваш запрос…",
            "high_load": "⚠️ Сейчас высокая нагрузка. Запрос может занять больше времени.\n⭐ Premium — приоритетная очередь.",
            "illegal_block": "⛔ Этот запрос не может быть обработан.",
            "nsfw_choice_title": "🔞 Обнаружен NSFW-запрос",
            "nsfw_choice_desc": "Выберите, где генерировать изображение для взрослых:",
            "nsfw_enhanced_label": "📝 Улучшенный промпт:",
            "inline_choose_count": "🔢 Выберите количество изображений:",
            "inline_result_title": "🎨 Создать {n} изображений",
            "inline_result_desc": "Нажмите для начала (лимиты действуют)",
            "inline_processing": "🔄 Обрабатываю ваш запрос… ({n})",
            "profile_title": "👤 Ваш профиль",
            "profile_premium_active": "✅ Активен до: {until}",
            "profile_premium_inactive": "❌ Не активен",
            "profile_paid_left": "💎 Платных изображений осталось: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 Имя: {uname}\n🌐 Язык: {lang_name}\n🎛 Стиль: {style}\n⭐ Premium: {premium}\n\n📆 Бесплатно сегодня: {free_used}/{free_limit}\n🖼 Всего изображений: {total_images}\n🎨 Всего запросов: {total_requests}\n⭐ Premium изображений: {premium_images}\n",
        },
        "id": {
            "gen_button_short": "Buat Gambar",
            "ai_button_short": "Chat AI",
            "error": "⚠️ Terjadi kesalahan. Silakan coba lagi.",
            "stats_button": "📈 Statistik",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — lebih cepat, lebih kuat 🔥\n\n✅ 🔞 Konten dewasa terbuka 🍓\n✅ ⚡ Antrean prioritas\n✅ 🖼 4 gambar per permintaan\n✅ 🚫 Tanpa cooldown\n\n🆓 Free: 1 gambar, cooldown, batas harian, NSFW diblokir.",
            "premium_plan_24h": "24 Jam",
            "premium_plan_7d": "7 Hari",
            "premium_plan_30d": "30 Hari",
            "premium_buy": "Beli Premium",
            "premium_active_until": "✅ Premium aktif hingga: {until}",
            "premium_not_active": "❌ Premium tidak aktif.",
            "premium_activated": "✅ Premium diaktifkan! NSFW terbuka. Nikmati prioritas dan 4 gambar/batch!",
            "nsfw_blocked_free": "🔞 Konten dewasa hanya untuk Premium.\nTingkatkan untuk membuka NSFW 🍓 + 4 foto + prioritas ⚡",
            "batch_premium_only": "⭐ 2–4 gambar per permintaan hanya untuk Premium.",
            "quota_reached_friendly": "⏳ Kuota gratis Anda habis hari ini.\nIngin lebih? ⭐ Premium — tak terbatas + prioritas ⚡",
            "cooldown_friendly": "⏳ Tunggu {sec}d sebelum permintaan gratis berikutnya.\n⭐ Premium tidak ada cooldown.",
            "already_processing": "⚙️ Anda sudah memiliki permintaan aktif. Silakan tunggu.",
            "queued": "🕒 Dalam antrean! Perkiraan tunggu ~{sec}d.",
            "processing": "🔄 Memproses permintaan Anda…",
            "high_load": "⚠️ Beban tinggi sekarang. Permintaan mungkin membutuhkan lebih lama.\n⭐ Premium — antrean prioritas.",
            "illegal_block": "⛔ Permintaan ini tidak dapat diproses.",
            "nsfw_choice_title": "🔞 Permintaan NSFW Terdeteksi",
            "nsfw_choice_desc": "Pilih di mana menghasilkan gambar dewasa:",
            "nsfw_enhanced_label": "📝 Prompt yang disempurnakan:",
            "inline_choose_count": "🔢 Pilih jumlah gambar:",
            "inline_result_title": "🎨 Buat {n} gambar",
            "inline_result_desc": "Ketuk untuk mulai (batas berlaku)",
            "inline_processing": "🔄 Memproses permintaan Anda… ({n})",
            "profile_title": "👤 Profil Anda",
            "profile_premium_active": "✅ Aktif hingga: {until}",
            "profile_premium_inactive": "❌ Tidak aktif",
            "profile_paid_left": "💎 Sisa gambar berbayar: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 Nama: {uname}\n🌐 Bahasa: {lang_name}\n🎛 Gaya: {style}\n⭐ Premium: {premium}\n\n📆 Gratis hari ini: {free_used}/{free_limit}\n🖼 Total gambar: {total_images}\n🎨 Total permintaan: {total_requests}\n⭐ Gambar Premium: {premium_images}\n",
        },
        "lt": {
            "gen_button_short": "Kurti Vaizdą",
            "ai_button_short": "Pokalbis su AI",
            "error": "⚠️ Įvyko klaida. Bandykite dar kartą.",
            "stats_button": "📈 Statistika",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — greičiau, galingiau 🔥\n\n✅ 🔞 Suaugusiųjų turinys atrakintas 🍓\n✅ ⚡ Prioritetinė eilė\n✅ 🖼 4 vaizdai per užklausą\n✅ 🚫 Be laukimo\n\n🆓 Nemokamas: 1 vaizdas, laukimas, dienos limitas, NSFW blokuotas.",
            "premium_plan_24h": "24 val.",
            "premium_plan_7d": "7 dienos",
            "premium_plan_30d": "30 dienų",
            "premium_buy": "Pirkti Premium",
            "premium_active_until": "✅ Premium aktyvus iki: {until}",
            "premium_not_active": "❌ Premium neaktyvus.",
            "premium_activated": "✅ Premium aktyvuotas! NSFW atrakintas. Mėgaukitės prioritetu ir 4 vaizdų paketais!",
            "nsfw_blocked_free": "🔞 Suaugusiųjų turinys tik Premium nariams.\nAtnaujinkite — atrakinkite NSFW 🍓 + 4 nuotraukos + prioritetas ⚡",
            "batch_premium_only": "⭐ 2–4 vaizdai per užklausą tik Premium.",
            "quota_reached_friendly": "⏳ Išnaudojote nemokamą limitą šiandien.\nNorite daugiau? ⭐ Premium — neribota + prioritetas ⚡",
            "cooldown_friendly": "⏳ Palaukite {sec}s iki kitos nemokamos užklausos.\n⭐ Premium neturi laukimo.",
            "already_processing": "⚙️ Jau turite aktyvią užklausą. Palaukite, kol ji bus baigta.",
            "queued": "🕒 Eilėje! Numatomas laukimas ~{sec}s.",
            "processing": "🔄 Apdorojama jūsų užklausa…",
            "high_load": "⚠️ Dabar didelė apkrova. Užklausa gali užtrukti.\n⭐ Premium — prioritetinė eilė.",
            "illegal_block": "⛔ Šios užklausos negalima apdoroti.",
            "nsfw_choice_title": "🔞 Aptikta NSFW užklausa",
            "nsfw_choice_desc": "Pasirinkite, kur generuoti suaugusiųjų vaizdą:",
            "nsfw_enhanced_label": "📝 Patobulintas prompt'as:",
            "inline_choose_count": "🔢 Pasirinkite vaizdų skaičių:",
            "inline_result_title": "🎨 Sugeneruoti {n} vaizdus",
            "inline_result_desc": "Bakstelėkite pradėti (limitai galioja)",
            "inline_processing": "🔄 Apdorojama jūsų užklausa… ({n})",
            "profile_title": "👤 Jūsų profilis",
            "profile_premium_active": "✅ Aktyvus iki: {until}",
            "profile_premium_inactive": "❌ Neaktyvus",
            "profile_paid_left": "💎 Liko mokamų vaizdų: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 Vardas: {uname}\n🌐 Kalba: {lang_name}\n🎛 Stilius: {style}\n⭐ Premium: {premium}\n\n📆 Nemokama šiandien: {free_used}/{free_limit}\n🖼 Viso vaizdų: {total_images}\n🎨 Viso užklausų: {total_requests}\n⭐ Premium vaizdų: {premium_images}\n",
        },
        "esmx": {
            "gen_button_short": "Crear Imagen",
            "ai_button_short": "Chat IA",
            "error": "⚠️ Ocurrió un error. Por favor intenta de nuevo.",
            "stats_button": "📈 Estadísticas",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — más rápido, más potente 🔥\n\n✅ 🔞 Contenido adulto desbloqueado 🍓\n✅ ⚡ Cola prioritaria\n✅ 🖼 4 imágenes por solicitud\n✅ 🚫 Sin espera\n\n🆓 Gratis: 1 imagen, espera, límite diario, NSFW bloqueado.",
            "premium_plan_24h": "24 horas",
            "premium_plan_7d": "7 días",
            "premium_plan_30d": "30 días",
            "premium_buy": "Comprar Premium",
            "premium_active_until": "✅ Premium activo hasta: {until}",
            "premium_not_active": "❌ Premium no activo.",
            "premium_activated": "✅ ¡Premium activado! NSFW desbloqueado. ¡Disfruta de prioridad y 4 imágenes por lote!",
            "nsfw_blocked_free": "🔞 El contenido adulto solo está disponible en Premium.\nActualiza para desbloquear NSFW 🍓 + 4 fotos + prioridad ⚡",
            "batch_premium_only": "⭐ 2–4 imágenes por solicitud solo para Premium.",
            "quota_reached_friendly": "⏳ Usaste tu cuota gratuita de hoy.\n¿Quieres más? ⭐ Premium — ilimitado + prioridad ⚡",
            "cooldown_friendly": "⏳ Espera {sec}s antes de la siguiente solicitud gratuita.\n⭐ Premium no tiene espera.",
            "already_processing": "⚙️ Ya tienes una solicitud activa. Espera a que termine.",
            "queued": "🕒 ¡En cola! Espera estimada ~{sec}s.",
            "processing": "🔄 Procesando tu solicitud…",
            "high_load": "⚠️ Alta carga ahora. Tu solicitud puede tardar más.\n⭐ Premium — cola prioritaria.",
            "illegal_block": "⛔ Esta solicitud no puede procesarse.",
            "nsfw_choice_title": "🔞 Solicitud NSFW Detectada",
            "nsfw_choice_desc": "Elige dónde generar tu imagen adulta:",
            "nsfw_enhanced_label": "📝 Prompt mejorado:",
            "inline_choose_count": "🔢 Elige la cantidad de imágenes:",
            "inline_result_title": "🎨 Generar {n} imagen(es)",
            "inline_result_desc": "Toca para comenzar (aplican límites)",
            "inline_processing": "🔄 Procesando tu solicitud… ({n})",
            "profile_title": "👤 Tu Perfil",
            "profile_premium_active": "✅ Activo hasta: {until}",
            "profile_premium_inactive": "❌ No activo",
            "profile_paid_left": "💎 Imágenes de pago restantes: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 Usuario: {uname}\n🌐 Idioma: {lang_name}\n🎛 Estilo: {style}\n⭐ Premium: {premium}\n\n📆 Gratis hoy: {free_used}/{free_limit}\n🖼 Total imágenes: {total_images}\n🎨 Total solicitudes: {total_requests}\n⭐ Imágenes Premium: {premium_images}\n",
        },
        "eses": {
            "gen_button_short": "Crear Imagen",
            "ai_button_short": "Chat IA",
            "error": "⚠️ Se produjo un error. Por favor, inténtalo de nuevo.",
            "stats_button": "📈 Estadísticas",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — más rápido, más potente 🔥\n\n✅ 🔞 Contenido adulto desbloqueado 🍓\n✅ ⚡ Cola prioritaria\n✅ 🖼 4 imágenes por solicitud\n✅ 🚫 Sin espera\n\n🆓 Gratis: 1 imagen, espera, límite diario, NSFW bloqueado.",
            ...
            "premium_active_until": "✅ Premium activo hasta: {until}",
            "premium_not_active": "❌ Premium no activo.",
            "premium_activated": "✅ ¡Premium activado! NSFW desbloqueado. ¡Disfruta de prioridad y 4 imágenes!",
            "nsfw_blocked_free": "🔞 El contenido adulto solo está disponible en Premium.\nActualiza para desbloquear NSFW 🍓 + 4 fotos + prioridad ⚡",
            "batch_premium_only": "⭐ 2–4 imágenes por solicitud solo para Premium.",
            "quota_reached_friendly": "⏳ Has usado tu cuota gratuita de hoy.\n¿Quieres más? ⭐ Premium — ilimitado + prioridad ⚡",
            "cooldown_friendly": "⏳ Espera {sec}s antes de la siguiente solicitud gratuita.\n⭐ Premium no tiene espera.",
            "already_processing": "⚙️ Ya tienes una solicitud activa. Espera a que finalice.",
            "queued": "🕒 ¡En cola! Espera estimada ~{sec}s.",
            "processing": "🔄 Procesando tu solicitud…",
            "high_load": "⚠️ Alta carga ahora. Tu solicitud puede tardar más.\n⭐ Premium — cola prioritaria.",
            "illegal_block": "⛔ Esta solicitud no puede procesarse.",
        ...
        "it": {
            "gen_button_short": "Genera Immagine",
            "ai_button_short": "Chat IA",
            "error": "⚠️ Si è verificato un errore. Riprova.",
            "stats_button": "📈 Statistiche",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — più veloce, più potente 🔥\n\n✅ 🔞 Contenuto adulto sbloccato 🍓\n✅ ⚡ Coda prioritaria\n✅ 🖼 4 immagini per richiesta\n✅ 🚫 Nessun cooldown\n\n🆓 Gratuito: 1 immagine, cooldown, limite giornaliero, NSFW bloccato.",
            "premium_plan_24h": "24 ore",
            "premium_plan_7d": "7 giorni",
            "premium_plan_30d": "30 giorni",
            "premium_buy": "Acquista Premium",
            "premium_active_until": "✅ Premium attivo fino al: {until}",
            "premium_not_active": "❌ Premium non attivo.",
            "premium_activated": "✅ Premium attivato! NSFW sbloccato. Goditi la priorità e 4 immagini per batch!",
            "nsfw_blocked_free": "🔞 Il contenuto adulto è disponibile solo per Premium.\nAggiungi Premium per sbloccare NSFW 🍓 + 4 foto + priorità ⚡",
            "batch_premium_only": "⭐ 2–4 immagini per richiesta solo per Premium.",
            "quota_reached_friendly": "⏳ Hai esaurito la quota gratuita di oggi.\nVuoi di più? ⭐ Premium — illimitato + priorità ⚡",
            "cooldown_friendly": "⏳ Attendi {sec}s prima della prossima richiesta gratuita.\n⭐ Premium non ha cooldown.",
            "already_processing": "⚙️ Hai già una richiesta attiva. Attendi che finisca.",
            "queued": "🕒 In coda! Attesa stimata ~{sec}s.",
            "processing": "🔄 Elaborazione della tua richiesta…",
            "high_load": "⚠️ Alto carico adesso. La tua richiesta potrebbe richiedere più tempo.\n⭐ Premium — coda prioritaria.",
            "illegal_block": "⛔ Questa richiesta non può essere elaborata.",
            "nsfw_choice_title": "🔞 Richiesta NSFW Rilevata",
            "nsfw_choice_desc": "Scegli dove generare l'immagine per adulti:",
            "nsfw_enhanced_label": "📝 Prompt migliorato:",
            "inline_choose_count": "🔢 Scegli il numero di immagini:",
            "inline_result_title": "🎨 Genera {n} immagine/i",
            "inline_result_desc": "Tocca per iniziare (si applicano i limiti)",
            "inline_processing": "🔄 Elaborazione della tua richiesta… ({n})",
            "profile_title": "👤 Il Tuo Profilo",
            "profile_premium_active": "✅ Attivo fino al: {until}",
            "profile_premium_inactive": "❌ Non attivo",
            "profile_paid_left": "💎 Immagini a pagamento rimaste: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 Nome: {uname}\n🌐 Lingua: {lang_name}\n🎛 Stile: {style}\n⭐ Premium: {premium}\n\n📆 Gratuito oggi: {free_used}/{free_limit}\n🖼 Immagini totali: {total_images}\n🎨 Richieste totali: {total_requests}\n⭐ Immagini Premium: {premium_images}\n",
        },
        "zhcn": {
            "gen_button_short": "生成图像",
            "ai_button_short": "AI聊天",
            "error": "⚠️ 发生错误。请重试。",
            "stats_button": "📈 统计",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — 更快、更强 🔥\n\n✅ 🔞 解锁成人内容 🍓\n✅ ⚡ 优先队列\n✅ 🖼 每次4张图片\n✅ 🚫 无冷却时间\n\n🆓 免费: 1张图片、冷却时间、每日限制、NSFW已屏蔽。",
            "premium_plan_24h": "24小时",
            "premium_plan_7d": "7天",
            "premium_plan_30d": "30天",
            "premium_buy": "购买 Premium",
            "premium_active_until": "✅ Premium 有效期至: {until}",
            "premium_not_active": "❌ Premium 未激活。",
            "premium_activated": "✅ Premium 已激活！NSFW 已解锁。享受优先处理和4张图片批次！",
            "nsfw_blocked_free": "🔞 成人内容仅适用于 Premium 会员。\n升级以解锁 NSFW 🍓 + 4张图片 + 优先 ⚡",
            "batch_premium_only": "⭐ 每次2–4张图片仅限 Premium。",
            "quota_reached_friendly": "⏳ 您今天的免费配额已用完。\n想要更多？⭐ Premium — 无限 + 优先 ⚡",
            "cooldown_friendly": "⏳ 等待 {sec}s 后再发送下一个免费请求。\n⭐ Premium 无冷却时间。",
            "already_processing": "⚙️ 您已有一个活跃请求。请等待其完成。",
            "queued": "🕒 已排队！预计等待 ~{sec}s。",
            "processing": "🔄 正在处理您的请求…",
            "high_load": "⚠️ 当前负载较高。您的请求可能需要更长时间。\n⭐ Premium — 优先队列。",
            "illegal_block": "⛔ 此请求无法处理。",
            "nsfw_choice_title": "🔞 检测到 NSFW 请求",
            "nsfw_choice_desc": "选择在哪里生成成人图像:",
            "nsfw_enhanced_label": "📝 增强提示词:",
            "inline_choose_count": "🔢 选择图像数量:",
            "inline_result_title": "🎨 生成 {n} 张图像",
            "inline_result_desc": "点击开始 (限制适用)",
            "inline_processing": "🔄 处理您的请求中… ({n})",
            "profile_title": "👤 您的个人资料",
            "profile_premium_active": "✅ 有效期至: {until}",
            "profile_premium_inactive": "❌ 未激活",
            "profile_paid_left": "💎 剩余付费图像: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 用户名: {uname}\n🌐 语言: {lang_name}\n🎛 风格: {style}\n⭐ Premium: {premium}\n\n📆 今日免费: {free_used}/{free_limit}\n🖼 总图像数: {total_images}\n🎨 总请求数: {total_requests}\n⭐ Premium 图像: {premium_images}\n",
        },
        "bn": {
            "gen_button_short": "ছবি তৈরি করুন",
            "ai_button_short": "AI চ্যাট",
            "error": "⚠️ একটি ত্রুটি ঘটেছে। আবার চেষ্টা করুন।",
            "stats_button": "📈 পরিসংখ্যান",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — দ্রুততর, আরও শক্তিশালী 🔥\n\n✅ 🔞 প্রাপ্তবয়স্ক বিষয়বস্তু আনলক 🍓\n✅ ⚡ অগ্রাধিকার সারি\n✅ 🖼 প্রতি অনুরোধে ৪টি ছবি\n✅ 🚫 কোনো কুলডাউন নেই\n\n🆓 বিনামূল্যে: ১টি ছবি, কুলডাউন, দৈনিক সীমা, NSFW ব্লক।",
            "premium_plan_24h": "২৪ ঘণ্টা",
            "premium_plan_7d": "৭ দিন",
            "premium_plan_30d": "৩০ দিন",
            "premium_buy": "Premium কিনুন",
            "premium_active_until": "✅ Premium সক্রিয় পর্যন্ত: {until}",
            "premium_not_active": "❌ Premium সক্রিয় নয়।",
            "premium_activated": "✅ Premium সক্রিয়! NSFW আনলক হয়েছে। অগ্রাধিকার এবং ৪-ছবির ব্যাচ উপভোগ করুন!",
            "nsfw_blocked_free": "🔞 প্রাপ্তবয়স্ক বিষয়বস্তু শুধুমাত্র Premium এর জন্য।\nআপগ্রেড করুন — NSFW 🍓 + ৪ ছবি + অগ্রাধিকার ⚡ আনলক করুন",
            "batch_premium_only": "⭐ প্রতি অনুরোধে ২–৪টি ছবি শুধুমাত্র Premium এর জন্য।",
            "quota_reached_friendly": "⏳ আজকের বিনামূল্যের কোটা শেষ।\nআরও চান? ⭐ Premium — সীমাহীন + অগ্রাধিকার ⚡",
            "cooldown_friendly": "⏳ পরবর্তী বিনামূল্যের অনুরোধের আগে {sec}s অপেক্ষা করুন।\n⭐ Premium এ কুলডাউন নেই।",
            "already_processing": "⚙️ আপনার একটি সক্রিয় অনুরোধ আছে। অনুগ্রহ করে অপেক্ষা করুন।",
            "queued": "🕒 সারিতে! আনুমানিক অপেক্ষা ~{sec}s।",
            "processing": "🔄 আপনার অনুরোধ প্রক্রিয়া করা হচ্ছে…",
            "high_load": "⚠️ এখন উচ্চ লোড। আপনার অনুরোধ বেশি সময় নিতে পারে।\n⭐ Premium — অগ্রাধিকার সারি।",
            "illegal_block": "⛔ এই অনুরোধটি প্রক্রিয়া করা যাবে না।",
            "nsfw_choice_title": "🔞 NSFW অনুরোধ সনাক্ত",
            "nsfw_choice_desc": "প্রাপ্তবয়স্ক ছবি কোথায় তৈরি করবেন তা বেছে নিন:",
            "nsfw_enhanced_label": "📝 উন্নত প্রম্পট:",
            "inline_choose_count": "🔢 ছবির সংখ্যা বেছে নিন:",
            "inline_result_title": "🎨 {n}টি ছবি তৈরি করুন",
            "inline_result_desc": "শুরু করতে ট্যাপ করুন (সীমা প্রযোজ্য)",
            "inline_processing": "🔄 আপনার অনুরোধ প্রক্রিয়া হচ্ছে… ({n})",
            "profile_title": "👤 আপনার প্রোফাইল",
            "profile_premium_active": "✅ সক্রিয় পর্যন্ত: {until}",
            "profile_premium_inactive": "❌ সক্রিয় নয়",
            "profile_paid_left": "💎 বাকি পেইড ছবি: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 ব্যবহারকারী: {uname}\n🌐 ভাষা: {lang_name}\n🎛 স্টাইল: {style}\n⭐ Premium: {premium}\n\n📆 আজকের বিনামূল্যে: {free_used}/{free_limit}\n🖼 মোট ছবি: {total_images}\n🎨 মোট অনুরোধ: {total_requests}\n⭐ Premium ছবি: {premium_images}\n",
        },
        "hi": {
            "gen_button_short": "छवि बनाएं",
            "ai_button_short": "AI चैट",
            "error": "⚠️ एक त्रुटि हुई। कृपया पुनः प्रयास करें।",
            "stats_button": "📈 आँकड़े",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — तेज़, शक्तिशाली 🔥\n\n✅ 🔞 अडल्ट कंटेंट अनलॉक 🍓\n✅ ⚡ प्राथमिकता कतार\n✅ 🖼 4 छवियाँ प्रति अनुरोध\n✅ 🚫 कोई कूलडाउन नहीं\n\n🆓 मुफ़्त: 1 छवि, कूलडाउन, दैनिक सीमा, NSFW ब्लॉक।",
            "premium_plan_24h": "24 घंटे",
            "premium_plan_7d": "7 दिन",
            "premium_plan_30d": "30 दिन",
            "premium_buy": "Premium खरीदें",
            "premium_active_until": "✅ Premium सक्रिय है: {until} तक",
            "premium_not_active": "❌ Premium सक्रिय नहीं है।",
            "premium_activated": "✅ Premium सक्रिय! NSFW अनलॉक। प्राथमिकता और 4-छवि बैच का आनंद लें!",
            "nsfw_blocked_free": "🔞 अडल्ट कंटेंट केवल Premium के लिए।\nNSFW 🍓 + 4 फोटो + प्राथमिकता ⚡ अनलॉक करने के लिए अपग्रेड करें",
            "batch_premium_only": "⭐ प्रति अनुरोध 2–4 छवियाँ केवल Premium के लिए।",
            "quota_reached_friendly": "⏳ आज की मुफ़्त कोटा समाप्त हो गई।\nऔर चाहिए? ⭐ Premium — असीमित + प्राथमिकता ⚡",
            "cooldown_friendly": "⏳ अगले मुफ़्त अनुरोध से पहले {sec}s प्रतीक्षा करें।\n⭐ Premium में कूलडाउन नहीं है।",
            "already_processing": "⚙️ आपका एक सक्रिय अनुरोध पहले से है। कृपया प्रतीक्षा करें।",
            "queued": "🕒 कतार में! अनुमानित प्रतीक्षा ~{sec}s।",
            "processing": "🔄 आपका अनुरोध संसाधित हो रहा है…",
            "high_load": "⚠️ अभी उच्च लोड है। आपके अनुरोध में अधिक समय लग सकता है।\n⭐ Premium — प्राथमिकता कतार।",
            "illegal_block": "⛔ यह अनुरोध संसाधित नहीं किया जा सकता।",
            "fake_lab_generating": "🔄 AI फोटो बन रहा है...\n\n👤 यह व्यक्ति **वास्तविक नहीं है** — AI द्वारा बनाया गया!\n\n⏳ कृपया प्रतीक्षा करें...",
            "fake_lab_ready_caption": "👤 **यह व्यक्ति वास्तविक नहीं है!**\n🤖 AI द्वारा बनाया गया।\n\n🔄 नई छवि के लिए **रिफ्रेश** करें।",
            "fake_lab_refreshing": "🔄 **नई छवि लोड हो रही है...**\n⏳ कृपया प्रतीक्षा करें...",
            "fake_lab_error": "⚠️ **एक त्रुटि हुई।**\nकृपया पुनः प्रयास करें।",
            "progress_step_10": "🧠 प्रॉम्प्ट विश्लेषण...",
            "progress_step_25": "🎨 मॉडल चुनाव...",
            "progress_step_40": "🌈 रंग और संरचना...",
            "progress_step_60": "💡 प्रकाश संतुलन...",
            "progress_step_80": "🧩 विवरण अंतिम रूप...",
            "progress_step_100": "✅ वितरण के लिए तैयार...",
            "settings_menu_title": "⚙️ सेटिंग्स",
            "select_image_model_button": "🖼 छवि मॉडल चुनें",
            "stats_title": "🤖 Digen AI आँकड़े",
            "stats_ping": "⚡ पिंग",
            "stats_total_images": "🖼 कुल छवियाँ",
            "stats_today": "📆 आज",
            "stats_users": "👥 उपयोगकर्ता",
            "stats_new_30d": "🆕 पिछले 30 दिन",
            "stats_your_images": "👤 आपकी छवियाँ",
            "stats_refresh_button": "🔄 रिफ्रेश",
            "nsfw_choice_title": "🔞 NSFW अनुरोध पहचाना",
            "nsfw_choice_desc": "अडल्ट छवि कहाँ बनाएं:",
            "nsfw_enhanced_label": "📝 उन्नत प्रॉम्प्ट:",
            "inline_choose_count": "🔢 छवियों की संख्या चुनें:",
            "inline_result_title": "🎨 {n} छवि बनाएं",
            "inline_result_desc": "शुरू करने के लिए टैप करें (सीमाएँ लागू)",
            "inline_processing": "🔄 आपका अनुरोध प्रोसेस हो रहा है… ({n})",
            "profile_title": "👤 आपकी प्रोफ़ाइल",
            "profile_premium_active": "✅ सक्रिय तक: {until}",
            "profile_premium_inactive": "❌ सक्रिय नहीं",
            "profile_paid_left": "💎 शेष पेड छवियाँ: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 उपयोगकर्ता: {uname}\n🌐 भाषा: {lang_name}\n🎛 शैली: {style}\n⭐ Premium: {premium}\n\n📆 आज मुफ़्त: {free_used}/{free_limit}\n🖼 कुल छवियाँ: {total_images}\n🎨 कुल अनुरोध: {total_requests}\n⭐ Premium छवियाँ: {premium_images}\n",
        },
        "ptbr": {
            "gen_button_short": "Gerar Imagem",
            "ai_button_short": "Chat IA",
            "error": "⚠️ Ocorreu um erro. Por favor, tente novamente.",
            "stats_button": "📈 Estatísticas",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — mais rápido, mais poderoso 🔥\n\n✅ 🔞 Conteúdo adulto desbloqueado 🍓\n✅ ⚡ Fila prioritária\n✅ 🖼 4 imagens por solicitação\n✅ 🚫 Sem cooldown\n\n🆓 Grátis: 1 imagem, cooldown, limite diário, NSFW bloqueado.",
            "premium_plan_24h": "24 horas",
            "premium_plan_7d": "7 dias",
            "premium_plan_30d": "30 dias",
            "premium_buy": "Comprar Premium",
            "premium_active_until": "✅ Premium ativo até: {until}",
            "premium_not_active": "❌ Premium não ativo.",
            "premium_activated": "✅ Premium ativado! NSFW desbloqueado. Aproveite prioridade e 4 imagens por lote!",
            "nsfw_blocked_free": "🔞 Conteúdo adulto disponível apenas no Premium.\nAtualize para desbloquear NSFW 🍓 + 4 fotos + prioridade ⚡",
            "batch_premium_only": "⭐ 2–4 imagens por solicitação apenas para Premium.",
            "quota_reached_friendly": "⏳ Você usou sua cota gratuita de hoje.\nQuer mais? ⭐ Premium — ilimitado + prioridade ⚡",
            "cooldown_friendly": "⏳ Aguarde {sec}s antes da próxima solicitação gratuita.\n⭐ Premium não tem cooldown.",
            "already_processing": "⚙️ Você já tem uma solicitação ativa. Aguarde sua conclusão.",
            "queued": "🕒 Na fila! Espera estimada ~{sec}s.",
            "processing": "🔄 Processando sua solicitação…",
            "high_load": "⚠️ Alta carga agora. Sua solicitação pode demorar mais.\n⭐ Premium — fila prioritária.",
            "illegal_block": "⛔ Esta solicitação não pode ser processada.",
            "nsfw_choice_title": "🔞 Solicitação NSFW Detectada",
            "nsfw_choice_desc": "Escolha onde gerar sua imagem adulta:",
            "nsfw_enhanced_label": "📝 Prompt aprimorado:",
            "inline_choose_count": "🔢 Escolha a quantidade de imagens:",
            "inline_result_title": "🎨 Gerar {n} imagem(ns)",
            "inline_result_desc": "Toque para começar (limites se aplicam)",
            "inline_processing": "🔄 Processando sua solicitação… ({n})",
            "profile_title": "👤 Seu Perfil",
            "profile_premium_active": "✅ Ativo até: {until}",
            "profile_premium_inactive": "❌ Não ativo",
            "profile_paid_left": "💎 Imagens pagas restantes: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 Usuário: {uname}\n🌐 Idioma: {lang_name}\n🎛 Estilo: {style}\n⭐ Premium: {premium}\n\n📆 Grátis hoje: {free_used}/{free_limit}\n🖼 Total de imagens: {total_images}\n🎨 Total de solicitações: {total_requests}\n⭐ Imagens Premium: {premium_images}\n",
        },
        "ar": {
            "gen_button_short": "إنشاء صورة",
            "ai_button_short": "دردشة AI",
            "error": "⚠️ حدث خطأ. يرجى المحاولة مرة أخرى.",
            "stats_button": "📈 الإحصائيات",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — أسرع، أقوى 🔥\n\n✅ 🔞 محتوى للبالغين مفتوح 🍓\n✅ ⚡ طابور ذو أولوية\n✅ 🖼 4 صور لكل طلب\n✅ 🚫 بدون انتظار\n\n🆓 مجاني: صورة واحدة، انتظار، حد يومي، NSFW محظور.",
            "premium_plan_24h": "24 ساعة",
            "premium_plan_7d": "7 أيام",
            "premium_plan_30d": "30 يومًا",
            "premium_buy": "شراء Premium",
            "premium_active_until": "✅ Premium نشط حتى: {until}",
            "premium_not_active": "❌ Premium غير نشط.",
            "premium_activated": "✅ تم تفعيل Premium! تم فتح NSFW. استمتع بالأولوية و4 صور دفعة!",
            "nsfw_blocked_free": "🔞 المحتوى للبالغين متاح فقط لـ Premium.\nرقّي خطتك لفتح NSFW 🍓 + 4 صور + أولوية ⚡",
            "batch_premium_only": "⭐ 2–4 صور لكل طلب فقط لـ Premium.",
            "quota_reached_friendly": "⏳ لقد استنفدت حصتك المجانية اليوم.\nتريد المزيد؟ ⭐ Premium — غير محدود + أولوية ⚡",
            "cooldown_friendly": "⏳ انتظر {sec}s قبل الطلب المجاني التالي.\n⭐ Premium لا يحتوي على انتظار.",
            "already_processing": "⚙️ لديك طلب نشط بالفعل. يرجى الانتظار.",
            "queued": "🕒 في الطابور! الانتظار المتوقع ~{sec}s.",
            "processing": "🔄 جارٍ معالجة طلبك…",
            "high_load": "⚠️ الحمل مرتفع الآن. قد يستغرق طلبك وقتًا أطول.\n⭐ Premium — طابور ذو أولوية.",
            "illegal_block": "⛔ لا يمكن معالجة هذا الطلب.",
            "nsfw_choice_title": "🔞 تم اكتشاف طلب NSFW",
            "nsfw_choice_desc": "اختر أين تُنشئ صورتك للبالغين:",
            "nsfw_enhanced_label": "📝 برومبت محسّن:",
            "inline_choose_count": "🔢 اختر عدد الصور:",
            "inline_result_title": "🎨 إنشاء {n} صورة",
            "inline_result_desc": "اضغط للبدء (تطبق القيود)",
            "inline_processing": "🔄 جارٍ معالجة طلبك… ({n})",
            "profile_title": "👤 ملفك الشخصي",
            "profile_premium_active": "✅ نشط حتى: {until}",
            "profile_premium_inactive": "❌ غير نشط",
            "profile_paid_left": "💎 الصور المدفوعة المتبقية: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 المستخدم: {uname}\n🌐 اللغة: {lang_name}\n🎛 النمط: {style}\n⭐ Premium: {premium}\n\n📆 مجاني اليوم: {free_used}/{free_limit}\n🖼 إجمالي الصور: {total_images}\n🎨 إجمالي الطلبات: {total_requests}\n⭐ صور Premium: {premium_images}\n",
        },
        "uk": {
            "gen_button_short": "Створити зображення",
            "ai_button_short": "Чат з AI",
            "error": "⚠️ Сталася помилка. Спробуйте ще раз.",
            "stats_button": "📈 Статистика",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — швидше, потужніше 🔥\n\n✅ 🔞 Контент для дорослих розблоковано 🍓\n✅ ⚡ Пріоритетна черга\n✅ 🖼 4 зображення за запит\n✅ 🚫 Без затримок\n\n🆓 Безкоштовно: 1 зображення, затримка, денний ліміт, NSFW заблоковано.",
            "premium_plan_24h": "24 години",
            "premium_plan_7d": "7 днів",
            "premium_plan_30d": "30 днів",
            "premium_buy": "Купити Premium",
            "premium_active_until": "✅ Premium активний до: {until}",
            "premium_not_active": "❌ Premium не активний.",
            "premium_activated": "✅ Premium активовано! NSFW розблоковано. Насолоджуйтесь пріоритетом і 4 зображеннями за пакет!",
            "nsfw_blocked_free": "🔞 Контент для дорослих доступний лише для Premium.\nОновіть план — розблокуйте NSFW 🍓 + 4 фото + пріоритет ⚡",
            "batch_premium_only": "⭐ 2–4 зображення за запит лише для Premium.",
            "quota_reached_friendly": "⏳ Ви вичерпали безкоштовну квоту на сьогодні.\nХочете більше? ⭐ Premium — безліміт + пріоритет ⚡",
            "cooldown_friendly": "⏳ Зачекайте {sec}с перед наступним безкоштовним запитом.\n⭐ Premium не має затримок.",
            "already_processing": "⚙️ У вас вже є активний запит. Будь ласка, зачекайте.",
            "queued": "🕒 У черзі! Орієнтовне очікування ~{sec}с.",
            "processing": "🔄 Обробляю ваш запит…",
            "high_load": "⚠️ Зараз високе навантаження. Ваш запит може зайняти більше часу.\n⭐ Premium — пріоритетна черга.",
            "illegal_block": "⛔ Цей запит не може бути оброблений.",
            "nsfw_choice_title": "🔞 Виявлено NSFW запит",
            "nsfw_choice_desc": "Оберіть, де генерувати зображення для дорослих:",
            "nsfw_enhanced_label": "📝 Покращений промпт:",
            "inline_choose_count": "🔢 Оберіть кількість зображень:",
            "inline_result_title": "🎨 Згенерувати {n} зображення",
            "inline_result_desc": "Торкніться для початку (ліміти діють)",
            "inline_processing": "🔄 Обробляю ваш запит… ({n})",
            "profile_title": "👤 Ваш профіль",
            "profile_premium_active": "✅ Активний до: {until}",
            "profile_premium_inactive": "❌ Не активний",
            "profile_paid_left": "💎 Залишилось платних зображень: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 Ім'я: {uname}\n🌐 Мова: {lang_name}\n🎛 Стиль: {style}\n⭐ Premium: {premium}\n\n📆 Безкоштовно сьогодні: {free_used}/{free_limit}\n🖼 Всього зображень: {total_images}\n🎨 Всього запитів: {total_requests}\n⭐ Premium зображень: {premium_images}\n",
        },
        "vi": {
            "gen_button_short": "Tạo Ảnh",
            "ai_button_short": "Chat AI",
            "error": "⚠️ Đã xảy ra lỗi. Vui lòng thử lại.",
            "stats_button": "📈 Thống kê",
            "premium_button": "⭐ Premium",
            "premium_title": "⭐ Premium",
            "premium_desc": "Premium — nhanh hơn, mạnh hơn 🔥\n\n✅ 🔞 Nội dung người lớn được mở khóa 🍓\n✅ ⚡ Hàng đợi ưu tiên\n✅ 🖼 4 ảnh mỗi yêu cầu\n✅ 🚫 Không cooldown\n\n🆓 Miễn phí: 1 ảnh, cooldown, giới hạn hàng ngày, NSFW bị chặn.",
            "premium_plan_24h": "24 giờ",
            "premium_plan_7d": "7 ngày",
            "premium_plan_30d": "30 ngày",
            "premium_buy": "Mua Premium",
            "premium_active_until": "✅ Premium hoạt động đến: {until}",
            "premium_not_active": "❌ Premium không hoạt động.",
            "premium_activated": "✅ Premium đã được kích hoạt! NSFW đã mở khóa. Tận hưởng ưu tiên và 4 ảnh/lô!",
            "nsfw_blocked_free": "🔞 Nội dung người lớn chỉ dành cho Premium.\nNâng cấp để mở khóa NSFW 🍓 + 4 ảnh + ưu tiên ⚡",
            "batch_premium_only": "⭐ 2–4 ảnh mỗi yêu cầu chỉ dành cho Premium.",
            "quota_reached_friendly": "⏳ Bạn đã dùng hết hạn ngạch miễn phí hôm nay.\nMuốn thêm? ⭐ Premium — không giới hạn + ưu tiên ⚡",
            "cooldown_friendly": "⏳ Chờ {sec}s trước yêu cầu miễn phí tiếp theo.\n⭐ Premium không có cooldown.",
            "already_processing": "⚙️ Bạn đã có một yêu cầu đang hoạt động. Vui lòng chờ.",
            "queued": "🕒 Trong hàng đợi! Thời gian chờ ước tính ~{sec}s.",
            "processing": "🔄 Đang xử lý yêu cầu của bạn…",
            "high_load": "⚠️ Tải cao hiện tại. Yêu cầu của bạn có thể mất nhiều thời gian hơn.\n⭐ Premium — hàng đợi ưu tiên.",
            "illegal_block": "⛔ Yêu cầu này không thể được xử lý.",
            "nsfw_choice_title": "🔞 Phát hiện Yêu cầu NSFW",
            "nsfw_choice_desc": "Chọn nơi tạo ảnh người lớn:",
            "nsfw_enhanced_label": "📝 Prompt nâng cao:",
            "inline_choose_count": "🔢 Chọn số lượng ảnh:",
            "inline_result_title": "🎨 Tạo {n} ảnh",
            "inline_result_desc": "Nhấn để bắt đầu (giới hạn áp dụng)",
            "inline_processing": "🔄 Đang xử lý yêu cầu của bạn… ({n})",
            "profile_title": "👤 Hồ sơ của bạn",
            "profile_premium_active": "✅ Hoạt động đến: {until}",
            "profile_premium_inactive": "❌ Không hoạt động",
            "profile_paid_left": "💎 Ảnh trả phí còn lại: {n}",
            "profile_stats": "🆔 ID: {id}\n👤 Tên: {uname}\n🌐 Ngôn ngữ: {lang_name}\n🎛 Phong cách: {style}\n⭐ Premium: {premium}\n\n📆 Miễn phí hôm nay: {free_used}/{free_limit}\n🖼 Tổng ảnh: {total_images}\n🎨 Tổng yêu cầu: {total_requests}\n⭐ Ảnh Premium: {premium_images}\n",
        },
    }

    for lc, keys in _ALL_LANG_PATCHES.items():
        ld = LANGUAGES.get(lc)
        if ld is not None:
            for k, v in keys.items():
                ld.setdefault(k, v)

    # Also patch uz for the 2 missing keys
    LANGUAGES["uz"].setdefault("gen_button_short", "Rasm Yaratish")
    LANGUAGES["uz"].setdefault("ai_button_short", "AI bilan Suhbat")

    # Fallback for ALL languages for any still-missing keys
    _en_ref = LANGUAGES.get("en", {})
    for lc, ld in LANGUAGES.items():
        if lc == "en":
            continue
        for k, v in _en_ref.items():
            ld.setdefault(k, v)
...
def _contains_illegal(prompt: str) -> bool:
    ...
    for pat in _ILLEGAL_SEXUAL_VIOLENCE:
        try:
    ...
    # 2) Minor terms: block only if also NSFW context
    minor_hit = False
    for pat in _ILLEGAL_MINOR_PATTERNS:
        try:
            if re.search(pat, p, flags=re.IGNORECASE):
                minor_hit = True
                break
    ...
    # NSFW context patterns (lightweight, multilingual)
    nsfw_context = [
        r"\bsex\b", r"\bsexy\b", r"\bporn\b", r"\berotic\b", r"\bnude\b", r"\bnaked\b",
        r"\bpenis\b", r"\bvagina\b", r"\bpussy\b", r"\bdick\b", r"\bcock\b",
        r"\bporno\b", r"\bseks\b", r"\byalang\b", r"\bэрот\b", r"\bпорно\b", r"\bсекс\b",
        r"🔞", r"🍓"
    ]
    for pat in nsfw_context:
        try:
            if re.search(pat, p, flags=re.IGNORECASE):
                return True
        except re.error:
    ...
    # Minor without NSFW context -> allow (e.g., normal family scene)
    return False
...
# ═══════════════════════════════════════════════════════════════════════════════
# FINAL LANG SYNC — EN kalitlarini barcha tillarga setdefault orqali nusxalash
# Bu blok _ensure_lang_keys() va _patch_lang_copy() dan KEYIN ishlaydi,
# shuning uchun EN'da bo'lgan BARCHA kalitlar boshqa tillarga fallback bo'ladi.
# ═══════════════════════════════════════════════════════════════════════════════
def _final_lang_sync():
    en = LANGUAGES.get("en", {})
    # Per-language native translations for commonly missing keys
    _NATIVE = {
        "ru": {
            "gen_button_short": "🎨 Создать изображение",
            "ai_button_short": "🤖 Чат с ИИ",
            ...
            "donate_description": "Ваша поддержка помогает нам развиваться!",
            "donate_prompt": "Введите сумму в Stars:",
            "donate_thanks": "💖 Спасибо за поддержку!",
            "donate_invalid": "⚠️ Неверная сумма. Введите число.",
            "no_permission": "⛔ У вас нет прав.",
            "not_found": "❌ Не найдено.",
            "success": "✅ Успешно!",
            "done": "✅ Готово!",
            "sub_prompt": "📢 Подпишитесь на канал:",
            "sub_url_text": "📢 Открыть канал",
            "sub_check": "✅ Проверить подписку",
            "sub_thanks": "✅ Спасибо за подписку!",
            "sub_still_not": "❌ Вы ещё не подписаны.",
            "no_charge_id": "❌ ID платежа не найден.",
            "refund_success": "✅ Возврат выполнен.",
            "refund_error": "⚠️ Ошибка возврата.",
            "usage_refund": "Возврат: {reason}",
            "select_count": "🔢 Выберите количество:",
            "select_lang": "🌐 Выберите язык:",
            "lang_changed": "✅ Язык изменён.",
            "your_message": "Ваше сообщение",
            "your_message_label": "Ваше сообщение:",
            "your_prompt_label": "Ваш запрос:",
            "get_no_args_private": "✏️ Напишите запрос после команды /get",
            "get_no_args_group": "✏️ Напишите запрос после команды /get",
            "generating": "🔄 Генерирую изображение…",
            "generating_progress": "🔄 Генерирую… {pct}%",
            "image_delayed": "⏳ Изображение немного задерживается…",
            "image_ready_header": "✅ Изображение готово!",
            "image_prompt_label": "📝 Запрос:",
            "image_model_label": "🤖 Модель:",
            "image_count_label": "🖼 Количество:",
            "image_time_label": "⏱ Время:",
            "image_elapsed_label": "⏱ Затрачено:",
            "choose_action": "Выберите действие:",
            "choose_action_prompt": "Что вы хотите сделать?",
            "prompt_text": "Напишите запрос для генерации изображения:",
            "ai_prompt_text": "Напишите сообщение для AI:",
            "ai_response_header": "🤖 AI:",
            "ai_button": "🤖 AI чат",
            "gen_button": "🎨 Создать изображение",
            "lang_button": "🌐 Язык",
            "admin_user": "👤 Пользователь:",
    ...
    for lc, ld in LANGUAGES.items():
        if lc == "en":
            continue
        # 1. Apply native translations first
        native = _NATIVE.get(lc, {})
        for k, v in native.items():
            ld.setdefault(k, v)
        # 2. EN fallback for everything still missing
        for k, v in en.items():
            ld.setdefault(k, v)
...
async def inline_query_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    Inline mode: user types @Bot prompt in ANY chat.
    We can't "ask" questions like in private chat, so we return multiple inline results:
    - Free user: 1 image option
    - Premium user: 1/2/3/4 options
    The chosen result_id encodes the count: ig:1 / ig:2 / ig:3 / ig:4
    """
    ...
    pool = context.application.bot_data["db_pool"]
    await add_user_db(pool, iq.from_user)
    row = await get_user_row(pool, iq.from_user.id)
    lang_code = (row["language_code"] if row else DEFAULT_LANGUAGE)
    lang = get_lang(lang_code)
    is_premium = _is_premium_row(row)

    if not query:
        await _inline_answer(iq, results=[], hint_text=f"{t(lang,'inline_choose_count')}  @{bot_username} <prompt>", start_parameter="start")
        return

    counts = [1] if not is_premium else [1, 2, 3, 4]
    results = []
    for n in counts:
        rid = f"ig:{n}"
        title = t(lang, "inline_result_title", n=n)
        desc = t(lang, "inline_result_desc")
        content = InputTextMessageContent(t(lang, "inline_processing", n=n), disable_web_page_preview=True)
        results.append(InlineQueryResultArticle(id=rid, title=title, description=desc, input_message_content=content))

    await _inline_answer(iq, results=results, hint_text="Open bot for Profile / Premium / Style", start_parameter="start")


async def chosen_inline_result_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    After user taps one of inline results, Telegram sends chosen_inline_result with inline_message_id + result_id.
    We then enqueue generation and later EDIT that inline message into a photo.
    """
    ...
    # subscription gating: can't show join buttons in other chats
    if not await check_subscription(user.id, context):
        try:
            await context.bot.edit_message_text(
                inline_message_id=inline_message_id,
                text="🔒 Please open the bot, subscribe to the channel, then try inline again.",
            )
        except Exception:
            pass
        return
    ...
    if not is_premium:
        ...
        count = max(1, min(PREMIUM_IMAGE_COUNT, count))

    # Safety block (minor+nsfw or forced etc)
    if _contains_illegal(prompt):
        try:
            await context.bot.edit_message_text(inline_message_id=inline_message_id, text=t(lang, "illegal_block"))
        except Exception:
            pass
        return
    ...
    try:
        ...
        pass
# Patch process_job to deliver inline if inline_message_id exists (collage for 2-4)
...
async def _make_collage(urls: list) -> bytes:
    """
    Make a single collage image from 2-4 urls so inline mode can deliver "multiple" images.
    2 => 1x2, 3-4 => 2x2
    """
    from io import BytesIO
    ...
    if n == 1:
        out = BytesIO()
        imgs[0].save(out, format="JPEG", quality=92)
        return out.getvalue()
    ...
    for im in imgs:
        w, h = im.size
        scale = target / max(1, h)
        nw = int(w * scale)
        resized.append(im.resize((nw, target)))

    if n == 2:
        w = resized[0].size[0] + resized[1].size[0]
        ...
        # 2x2 grid (pad missing)
        cell = 512
        grid = []
        for im in imgs:
            grid.append(im.resize((cell, cell)))
        while len(grid) < 4:
            grid.append(Image.new("RGB", (cell, cell), (20, 20, 20)))
        canvas = Image.new("RGB", (cell * 2, cell * 2))
        canvas.paste(grid[0], (0, 0))
        canvas.paste(grid[1], (cell, 0))
        canvas.paste(grid[2], (0, cell))
        canvas.paste(grid[3], (cell, cell))
...
def build_app():
    ...
    app.add_handler(MessageHandler(filters.ChatType.PRIVATE & ~filters.COMMAND, forward_to_admin_handler), group=99)
...
async def forward_to_admin_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    SILENT SUPPORT RELAY (requested):
    - Any message a user sends to the bot in PRIVATE chat (text/media/files) is copied to ADMIN.
    - The user receives NO "Received" reply (bot can stay silent).
    ...
    try:
        # Copy the original message (keeps original text/media)
        ...
        meta = (
            f"📩 New message\n"
            f"👤 {uname} (ID: {update.effective_user.id})\n"
            f"⏰ {tashkent_time().strftime('%Y-%m-%d %H:%M:%S')} (UTC+5)"
        )
